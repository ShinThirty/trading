...
EXPECTED_TOOLS: dict[str, set[str]] = {
    "trading_mcp.tools.account": {
        ...
        "get_webull_accounts",
        "get_webull_instruments",
        "get_snaptrade_accounts",
        "get_snaptrade_balances",
        "get_snaptrade_positions",
        "get_snaptrade_activities",
    ...
    "trading_mcp.tools.orders": {
        ...
        "get_webull_order_detail",
        "preview_webull_order",
        "place_webull_order",
        "replace_webull_order",
        "cancel_webull_order",
    },
