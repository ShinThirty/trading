"""Polymarket Gamma API HTTP transport (public, no auth).

The Gamma API at gamma-api.polymarket.com serves market metadata and current
yes/no pricing. No API key is required for read-only access. Polite User-Agent
plus light rate limiting.
"""
