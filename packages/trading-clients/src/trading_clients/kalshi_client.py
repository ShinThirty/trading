"""Kalshi Elections API HTTP transport (public read-only, no auth).

api.elections.kalshi.com serves event/market data without authentication for
read-only queries. Auth is only required to place orders — which we don't do.
Polite User-Agent plus light rate limiting.
"""
