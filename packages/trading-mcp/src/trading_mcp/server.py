...
async def _gather_option_matches(
    ...
    """Fetch quotes, expirations, and chains for multiple symbols, returning
    the option closest to target_delta for each."""
    today = date.today()
...
async def compare_credit_efficiency(
    ...
    columns = [
        "Symbol", "Price", "Strike", "Exp", "DTE", "Delta",
        "Bid", "Ann Yld %", "OTM %", "C/Y", "Spread %",
    ]
